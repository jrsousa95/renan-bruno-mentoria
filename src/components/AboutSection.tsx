  ...
  const features = [
    {
      ...
      description: "Encontros exclusivos com especialistas em vendas",
    },
    {
      icon: Clock,
      title: "Metodologia Comprovada",
      description: "Sistema testado por mais de 10.000 empreendedores",
    },
    {
      icon: Users,
      title: "Comunidade Fechada",
      description: "Networking com empresários de alto nível",
    },
    {
      icon: CheckCircle,
      title: "Feedback Personalizado",
      description: "Análise individual do seu processo de vendas",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-brand-gray-600 leading-relaxed">
              Nossa mentoria foi desenvolvida para empreendedores que desejam
              dominar a arte das vendas e multiplicar seus resultados através de
              técnicas comprovadas e estratégias de alto impacto.
            </p>
            ...
            <div className="pt-6">
              <button className="bg-brand-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-brand-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg">
                Começar Agora
              </button>
            </div>
          </div>
